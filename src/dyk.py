...
os.system("wget " + mpsrc + " -O "+ fullpath + "/temp/wmpsrc.html > /dev/null 2>&1")
file = open(fullpath + "/temp/wmpsrc.html", "r")
...
# os.system("rm " + fullpath + "/wmpsrc.html") := instead, the temp folder is cleared.
